                    ...
                    <a href="/users.php" class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0">Number Of Users: <?=countNoOfRecords("users"); ?></h6>
                            </div>
                        </div>
                    </a>
                    <a href="/applications.php" class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-chart-bar fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Applications</p>
                                <h6 class="mb-0">No Of Applications: <?=countNoOfRecords("applications"); ?></h6>
                            </div>
                        </div>
                    </a>
                    <a href="/tasks" class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0">Number of Task: <?=countNoOfRecords("tasksss"); ?></h6>
                            </div>
                        </div>
                    </a>
