            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Add Project
                            <a href="project_create.html" class="btn btn-danger float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
...
<?= alertMessage(); ?> 
                        <form action="admin/code.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label>Hours_Logged</label>
                                        <input type="text" name="hours_logged" value="00:00:00" disabled class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="progress_status" value='Incomplete'class="form-select">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 text-end">
                                    <br>
                                    <button type="submit" name="saveProject" class="btn btn-primary">Save</button>
                                </div>
                            </div>
