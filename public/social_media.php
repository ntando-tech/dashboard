            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Social Media List
                            <a href="social_media_create.html" class="btn btn-primary float-end">Add Social Media</a>
                        </h4>
                    </div>
                    <div class="card-body">
                     ...
                     <!-- alertMessage();?> -->
                        ...
                        <table id="socialmediatable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
                            ...
                            {
                            foreach($socialmedias as $socialmediaItem)
                            {
                                ?>
                                <tr>
                                <td><?=$socialmediaItem['id'];?></td>
                                <td><?=$socialmediaItem['name'];?></td>
                                <td><?=$socialmediaItem['url'];?></td>
                                <td><?=$socialmediaItem['status'] == 1 ? 'Hidden' : 'Shown'; ?></td>
                                <td>
                                    <a href="social_media_edit.php?id=<?=$socialmediaItem['id'];?>" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="social_media_delete.php?id=<?=$socialmediaItem['id'];?>" 
