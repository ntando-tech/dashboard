            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Create Message
                            <a href="users-create.html" class="btn btn-danger float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
...
<?= alertMessage(); ?>
                        ...
                        <form action="admin/code.php" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="role" value='admin'class="form-select">
                                    <option value="">Select </option>
                                    <option value="admin">All Employees</option>
                                    <option value="i.t technician">new guy</option>
                                    <option value="receptionist">new girl</option>
                            ...
                            foreach($users as $userItem)
                            {
                                ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="firstnamee" value="<?=$userItem['firstname'];?>" required class="form-control">
                                        <input type="text" name="from_email" value="<?=$userItem['email'];?>" hidden required class="form-control">
                                        <input type="text" name="from_profile" value="<?=$userItem['profile_image'];?>" hidden required class="form-control">
                                    </div>
                                </div>    
                                   <?php
                        }
                        ...
                        <?php endif; ?>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="mb-3">
                                    <label><b>Select Employees</b></label>
                                    <select  name="sendingto" value='admin'class="form-select">
                            ...
                            {
                                ?>
                                <option name="sendingto" value="<?=$userItem['email'];?>" style="border-radius:5px"><?=$userItem['firstname'].' '.$userItem['lastname'];?></option>
                            <?php
                        }
                        }
                        else
                        ...
                        ?>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="message" name="message" rows="3"  class="form-control" id="message"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 text-end">
                                    <br>
                                    <button type="submit" name="clearMessage" class="btn btn-warning">Clear</button>
                                </div>
                            </div>
