      ...
      <!-- //toggle switch for light and dark theme --> 
            ...
            <div class="row h-100  align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                <form action="admin/code.php" enctype="multipart/form-data" method="POST" >
                        ...
                        <input type="file" id="fileApplicationForm" name="fileApplicationForm" class="form-control bg-light" required  accept=".pdf,application/pdf">
                         </div>
                        <div class="form-group mb-4">
                        <label for="fileIdCopy"><b>Id Copy</b> <span class="text-danger">*</span>  </label>   
                         <input type="file" id="fileIdCopy" name="fileIdCopy" class="form-control bg-light"  required accept=".pdf,application/pdf">
                        </div>
                        <div class="form-group mb-4">
                            <label for="fileSchoolReport"><b>School Report</b> <span class="text-danger">*</span> </label>
                            <input type="file" id="fileSchoolReport" name="fileSchoolReport" class="form-control bg-light" required  accept=".pdf,application/pdf">
                        </div>

                        <button type="submit" name="submitApplication" class="btn btn-primary py-3 w-100 mb-4">Submit</button>
