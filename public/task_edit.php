<?php include("config/function.php"); 
 markNotificationAsRead('notifications', $_GET['id'], $_SESSION['loggedInUser']['id']);
?>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <a href="tasks.php" class="nav-item nav-link active"><i class="fa fa-tasks me-2"></i>Tasks</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="taskId" value="<?= $task['data']['id']; ?>" required>
