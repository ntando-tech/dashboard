        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <a href="applications.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Applications</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Application List
                            <a href="application_create.php" class="btn btn-primary float-end">Add Users</a>
                        </h4>
                    </div>
                    <div class="card-body">
                    ...
                    <!-- <?= alertMessage();?>--> 
                        ...
                        <table id="applicationtable" class="table table-bordered table-striped">
                            ...
                            {
                            foreach($application as $applicationItem)
                            {
                                ?>
                                <tr>
                                ...
                                <td>
                                    <a href="application_edit.php?id=<?=$applicationItem['id'];?>" class="btn btn-success btn-sm">Edit</a>
                                    <a href="application_delete.php?id=<?=$applicationItem['id'];?>" 
