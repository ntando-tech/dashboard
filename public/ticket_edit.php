        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <a href="tickets.php" class="nav-item nav-link active"><i class="fa fa-tasks me-2"></i>Tickets</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Edit Ticket
                            <a href="tickets.php" class="btn btn-primary float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                  ...
                  <form action="config/function.php" method="POST" >
                            ...
                            <?php
                              ...
                              $ticket = getById('tickets',checkParamId('id'));
                              if($ticket['status']== 200)
                              {
                                ?>


                        <input type="hidden" name="ticketId" value="<?= $ticket['data']['id']; ?>" required>

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Full name</h6>
                                        <input type="text" maxlength=50 name="fullName" value="<?=$ticket['data']['fullName'];?>" required readonly  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Email</h6>
                                        <input type="email" name="email" maxlength=50 value="<?=$ticket['data']['email'];?>"  required readonly class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Subject</h6>
                                        <input type="text" name="subject" required readonly  maxlength=100 value="<?= $ticket['data']['subject'];?>"  class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Description</h6>
                                        <input type="text" name="description" required readonly value="<?=$ticket['data']['description'];?>"  maxlength=500  class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Ticket Status</h6>
                                    <select name="ticket_status" required  class="form-select">
                                    <option value="<?=$ticket['data']['ticket_status'];?>"><?php if($ticket['data']['ticket_status']=='open'){echo 'Open';}
                                    elseif($ticket['data']['ticket_status']=='in_progress'){echo 'in_progress';}elseif($ticket['data']['ticket_status']=='resolved'){echo 'Resolve';}
                                    elseif($ticket['data']['ticket_status']=='closed'){echo 'Closed';} ?></option>
                                    <option value="open" <?= $ticket['data']['ticket_status'] == 'open'? 'hidden':'' ?> >Open</option>
                                    <option value="in_progress" <?= $ticket['data']['ticket_status'] == 'in_progress'? 'hidden':'' ?>>In Progress</option>
                                    <option value="resolved" <?= $ticket['data']['ticket_status'] == 'resolved'? 'hidden':'' ?>>Resolved</option>
                                    <option value="closed" <?= $ticket['data']['ticket_status'] == 'closed'? 'hidden':'' ?>>Closed</option>
                                      </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <option value="<?=$ticket['data']['priority'];?>"><?php if($ticket['data']['priority'] == 'low'){ echo'Low'; } elseif($ticket['data']['priority'] == 'medium'){echo 'Medium';}elseif($ticket['data']['priority'] == 'high'){echo 'High';}?></option>
                                    <option value="low" <?=$ticket['data']['priority'] == 'low' ? 'hidden' : '' ?>>Low</option>
                                    <option value="medium" <?=$ticket['data']['priority'] == 'medium' ? 'hidden' : '' ?> >Medium</option>
                                    <option value="high" <?=$ticket['data']['priority'] == 'high' ? 'hidden' : '' ?>>High</option>
                                      </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <br>
                                    <button type="submit" name="updateTicket" class="btn btn-primary">Update</button>
                                <!-- </div> -->
                                </div>
                                    </div>
