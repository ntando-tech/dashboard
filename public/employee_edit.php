        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <a href="employees.php" class="nav-item nav-link active"><i class="fas fa-user-friends"></i>Employees</a>
                    ...
                    <a href="todo.php" class="nav-item nav-link active"> <i class="fas fa-sign-out-alt"></i>To Do</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Edit Employee
                            <a href="employees.php" class="btn btn-primary float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="admin/code.php" method="POST" >
                            ...
                            <?php
                              ...
                              $user = getById('employees',checkParamId('id'));
                              if($user['status']== 200)
                              {
                                ?>


                        <input type="hidden" name="employeeId" value="<?= $user['data']['id']; ?>" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="province"  value="<?= $user['data']['province'];?>" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label>City</label>
                                        <input type="text" name="city"  value="<?= $user['data']['city'];?>" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label>Zip Code</label>
                                        <input type="text" name="zip_code"  value="<?= $user['data']['zip_code'];?>" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label>Street Name</label>
                                        <input type="text" name="street_name"  value="<?= $user['data']['street_name'];?>" required class="form-control">
                                    </div>
                                </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <option value="i.t technician" <?= $user['data']['role'] == 'i.t technician'? 'selected' : '';?>>I.T Technician</option>
                                    <option value="receptionist" <?= $user['data']['role'] == 'receptionist'? 'selected' : '';?>>Receptionist</option>
                                    <option value="guest" <?= $user['data']['role'] == 'guest'? 'selected' : '';?>>Guest</option>
                                      </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="account_status" class="form-select">
                                        <option value="active" <?php $user["data"]["account_status"]== "active"? "selected" : ""; ?>>Active</option>
                                        <option value="not active" <?php $user["data"]["account_status"] == "not active" ? "selected": "" ?>>Not Active</option>
                                        <option value="banned" <?php $user["data"]["account_status"] == "banned" ? "selected": ""?> >Banned</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4"> 
                                    <div class="mb-3">
                                        ...
                                        <input type="password" disabled name="password" value="<?= $user['data']['password'];?>" required class="form-control">
                                    </div>
                                </div> 
                                <div class="col-md-4"> 
                                    <div class="mb-3">
                                        <label>Confirm Password</label>
                                        <input type="password" disabled name="cpassword" value="<?= $user['data']['password'];?>" required class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="profile_image" value="<?= $user['data']['profile_image'];?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <br>
                                    <button type="submit" name="updateEmployee" class="btn btn-danger">Delete</button>
                                <!-- </div> -->
                                </div>
                                    </div>
                                <div class="col-md-4">
