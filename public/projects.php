            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Projects List
                            <a href="project_create.php" class="btn btn-primary float-end">Add Project</a>
                        </h4>
                    </div>
                    <div class="card-body">
                    ...
                    <!-- <?= alertMessage();?>--> 
                        ...
                        <table id="projectstable" class="table table-bordered table-striped">
                            ...
                            foreach($project as $projectItem)
                            {
                                ...
                                <td><?=$projectItem['team_members'];?></td>
                                <td><?=$projectItem['hours_logged'];?></td>
                                <td><?=$projectItem['progress_status'] == 1 ? 'Complete' : 'Incomplete'; ?></td>
                                <td><?=$projectItem['due_date'];?></td>

                                <td>
                                    <a href="project_edit.php?id=<?=$projectItem['id'];?>" class="btn btn-success btn-sm">Edit</a>
                                    <a href="project_delete.php?id=<?=$projectItem['id'];?>" 
