            ...
            <div class="col-md-12">
                <div class="card">
                  ...
                  <form action="admin/code.php" method="POST" >
                        ...
                        <input type="hidden" name="usersId" value="<?= $user['data']['id']; ?>" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="street_name"  value="<?= $user['data']['role'];?>" required class="form-control">
                                    </div>
                                </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4"> 
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="password" value="<?= $user['data']['password'];?>" required disabled class="form-control">
                                    </div>
                                </div> 
                                <div class="col-md-4"> 
                                    <div class="mb-3">
                                        <label>Confirm Password</label>
                                        <input type="password" name="cpassword" value="<?= $user['data']['password'];?>" disabled required class="form-control">
                                    </div>
                                </div>
