            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Edit Project
                            <a href="project_create.php" class="btn btn-danger float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="admin/code.php" method="POST">
                            ...
                            <?php
                              ...
                              $project = getById('projects',checkParamId('id'));
                              if($project['status']== 200)
                              {
                                ?>


                        <input type="hidden" name="userId" value="<?= $project['data']['id']; ?>" required>

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label>Project Name</label>
                                        <input type="text" name="project_name" value="<?= $project['data']['project_name'];?>" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label>Client</label>
                                        <input type="text" name="client"  value="<?= $project['data']['client'];?>" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="team_members"  value="<?= $project['data']['team_members'];?>" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label>Project Description</label>
                                        <input type="text" name="project_description"  value="<?= $project['data']['project_description'];?>" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6"> 
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" name="due_date" value="<?= $project['data']['due_date'];?>" required class="form-control">
                                    </div>
                                </div> 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <option value="begining" <?= $project['data']['progress_status'] == 'begining'? 'selected' : '';?> >Begining</option>
                                    <option value="medium" <?= $project['data']['progress_status'] == 'medium'? 'selected' : '';?>>Medium</option>
                                    <option value="Almost Done" <?= $project['data']['progress_status'] == 'Almost Done'? 'selected' : '';?>>Almost Done</option>
                                      </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label>Note</label>
                                    <br>
                                    <input type="text" name="note" value="<?= $project['data']['note'];?>" required class="form-control">
                                </div>
                            </div>
