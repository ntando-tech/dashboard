            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Tickets List
                            <a href="ticket_create.php" class="btn btn-primary float-end">Add Tickets</a>
                        </h4>
                    </div>
                    <div class="card-body">
                    ...
                    <!-- <?= alertMessage();?>--> 
                        ...
                        <table id="ticketstable" class="table table-bordered table-striped">
                            ...
                            foreach($tickets as $ticketItem)
                            {
                                ...
                                <td><?=$ticketItem['id'];?></td>
                                <td><?=$ticketItem['subject'];?></td>
                                <td><?=$ticketItem['description'];?></td>
                                <td><?=$ticketItem['ticket_status'];?></td>
                                <td><?=$ticketItem['priority'];?></td>
                                <td>
                                    <a href="ticket_edit.php?id=<?=$ticketItem['id'];?>" class="btn btn-success btn-sm">Edit</a>
                                    <a href="ticket_delete.php?id=<?=$ticketItem['id'];?>" 
