            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Employees List
                            <a href="employee_create.php" class="btn btn-primary float-end">Add Employee</a>
                        </h4>
                    </div>
                    <div class="card-body">
                    ...
                    <!-- <?= alertMessage();?>--> 
                        ...
                        <table id="employeestable" class="table table-bordered table-striped">
                            ...
                            foreach($users as $userItem)
                            {
                                ...
                                <td>
                                    <a href="employee_edit.php?id=<?=$userItem['id'];?>" class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil-square-o"></i>Edit</a>
                                    <a href="employee_delete.php?id=<?=$userItem['id'];?>" 
