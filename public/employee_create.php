                        ...
                        <form action="admin/code.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="idnumber" maxlength="13" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label>Phone Number <span class="text-danger">*</span> </label>
                                        <input type="text" name="phone" maxlength="10" placeholder="0123456789" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="street_name"  required class="form-control">
                                    </div>
                                </div>
                                 <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <option value="i.t technician">I.T Technician</option>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <select name="account_status" required class="form-select">
                            ...
                            <input type="text" name="created_by" hidden value="<?= $_SESSION['loggedInUser']['firstname'].' '. $_SESSION['loggedInUser']['lastname']; ?>"  class="form-control">
                            <input type="text" name="created_by_role" hidden value="<?= $_SESSION['loggedInUser']['role']; ?>"  class="form-control">
                            <?php  else:  redirect("signin.php", 401); endif; ?>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 text-center">
                                    <br>
                                    <button type="submit" name="saveNewEmployee" class="btn btn-primary">Save</button>
                                </div>
                            </div>
