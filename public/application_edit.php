            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            View Application
                            <a href="applications.php" class="btn btn-primary float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                  ...
                  <form action="admin/code.php" method="POST" >
                            ...
                            $user = getUserApplicationById($paramResult);
                        ...
                        <input type="hidden" name="applicationId" value="<?= $user['data']['grade']; ?>" required>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <h6>Full Name</h6>
                                        <input type="text" name="fullName" readonly value="<?= $user['data']['firstname'].' '. $user['data']['lastname'];?>" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <h6>Email</h6>
                                        <input type="text" name="email" readonly value="<?= $user['data']['email'];?>" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <h6>Phone Number</h6>
                                        <input type="text" name="phone" readonly  value="<?= $user['data']['phone'];?>" required class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <a href="<?= htmlspecialchars($user['data']['application_form']);?>" target="_blank">
                                        <img src="img/pdf icon.png" required class="form-control" style="width:30%">
                                        </a>
                                    </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                    <div class="mb-3">
                                        <h6>Id Copy</h6>
                                        <a href="<?= htmlspecialchars($user['data']['id_copy']);?>" target="_blank">
                                        <img src="img/pdf icon.png" required class="form-control" style="width:30%">
                                        </a>
                                    </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                    <div class="mb-3">
                                        <h6>School Report</h6>
                                        <a href="<?=htmlspecialchars($user['data']['school_report']);?>" target="_blank">
                                        <img src="img/pdf icon.png" download required class="form-control" style="width:30%">
                                        </a>
                                    </div>
                            </div>
                            ...
                            <div class="col-md-4">
                              ...
                              {
                                echo '<h5>'.$user['message']. ' '. var_dump($paramResult). '</h5>';
                              }
