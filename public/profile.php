            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Edit User
                            <a href="users-create.php" class="btn btn-danger float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="firstname" value="<?=$userItem['firstname'];?>" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label>Last Name</label>
                                            <input type="text" name="lastname"  value="<?=$userItem['lastname'];?>" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label>ID Number</label>
                                            <input type="text" name="idnumber"  value="<?=$userItem['idnumber'];?>" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label>Home Address</label>
                                            <input type="text" name="homeaddress"  value="<?=$userItem['home_address'];?>" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label>Phone Number</label>
                                            <input type="text" name="phone"  value="<?=$userItem['phone'];?>" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label>Email</label>
                                            <input type="text" name="email" value="<?=$userItem['email'];?>" required class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="col-md-3">
                                            ...
                                            <input type="password" name="password" value="<?=$userItem['password'];?>" required class="form-control">
                                        </div>
                                    </div> 
                                    <div class="col-md-6"> 
                                        <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <option value="<?=$userItem['role'];?>" ></option>
                                    </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label>Is Ban</label>
                                        <br>
                                        <input type="checkbox" name="is_ban" value="<?= $userItem["is_ban"] == true? 'checked' : '';?>" style="width:30px;height:30px"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <img class="rounded-circle" src="<?=$userItem['profile_image'];?>" alt="" style="width: 40px; height: 40px;">
                                        </div>
                                    </div>
