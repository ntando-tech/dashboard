                        ...
                        <form action="config/function.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Full name</h6>
                                        <input type="text" maxlength=50 name="fullName" required   class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Subject</h6>
                                        <input type="text" name="subject" required  maxlength=100  class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Description</h6>
                                        <input type="text" name="description" required  maxlength=500  class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h6>Created By</h6>
                                        <input type="text" name="created_by" required  readonly value="<?= $_SESSION['loggedInUser']['firstname'].' '.$_SESSION['loggedInUser']['lastname'] ?>" required  class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <br>
                                    <button type="reset" name="resetTicket" class="btn btn-warning">Cancel</button>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <br>
                                    <button type="submit" name="createTicketBtn" class="btn btn-primary">Save</button>
                                </div>
                            </div>
